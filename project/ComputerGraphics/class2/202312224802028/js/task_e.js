...
window.onload = function initTriangles() {
    ...
    document.getElementById("subdivide-input").addEventListener("input", updateTessellation);
    document.getElementById("theta-input").addEventListener("input", updateTessellation);
    document.getElementById("twist-checkbox").addEventListener("change", updateTessellation);
};

function updateTessellation() {
    numTimesToSubdivide = parseInt(document.getElementById("subdivide-input").value);
    theta = parseInt(document.getElementById("theta-input").value);
    twist = document.getElementById("twist-checkbox").checked;
